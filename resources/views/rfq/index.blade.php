@extends('layouts.app')
  ...
  <div class="container">
    <h1 class="title">Request For Quotation List</h1>
    ...
    <table class="table-table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td> <a class="bg-gray-700 py-1 px-4 rounded-sm text-white text-lg bg-opacity-50 hover:bg-red-800 focus:bg-white" href="/rfq/{{$rfq->id}}">view</a></td>
        </tr>
        @endforeach
