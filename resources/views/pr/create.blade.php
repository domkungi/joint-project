...
<form action="/pr/store" method="post">
    ...
    <body onload=startTime()>
        ...
        <div class="invoice-box">
            ...
            <h1 style="font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif;" class="py-10">Create Purchase Requisition</h1>
...
<table>
    ...
    <tr class="item">
        ...
        <td>
            ...
            <div class="mt-2 ">
                <input type="checkbox" value="{{$product->id}}" name="items[{{$loop->index}}][product_ids]">
        ...
        <td><input class="border-2 bg-gray-200 " type="text" name="items[{{$loop->index}}][qty]"></td>
