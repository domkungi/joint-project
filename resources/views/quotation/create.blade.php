...
@section('content')
<form action="/quotation/store/{{$inquiry->id}}" method="post">
    @csrf
        ...
        <div class="invoice-box">
            ...
            <table cellpadding="0" cellspacing="0">
                        ...
                        <table>
                            <tr>
                                ...
                                <td class=" font-serif">   Employee |
                                    ...
                                    Inquiry No | <input class="border-2 bg-gray-200 " type="text" value="IQ#00{{$inquiry->id}}"><br>
                                    Customer No | <input class="border-2 bg-gray-200" type="text" value="CS#00{{$inquiry->customer->id}}"> <br>
                ...
                <table class=" font-serif">
                    ...
                    <tr>
                        <td>
                            {{$inquiry->customer->company_name}}<br> {{$inquiry->customer->address}}<br>
                            {{$inquiry->customer->city}},{{$inquiry->customer->country}} {{$inquiry->customer->zipcode}}
                        </td>
                        <td>
                            {{$inquiry->customer->company_name}}<br> {{$inquiry->customer->address}}<br>
                            {{$inquiry->customer->city}},{{$inquiry->customer->country}} {{$inquiry->customer->zipcode}}
