...
@section('content')
<form action="/invoice/store/{{$saleorder->id}}" method="post">
    @csrf
    ...
    <body onload=startTime()>
        ...
        <div class="invoice-box">
            ...
            <h1 style="font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif;">Create Invoice</h1>
            ...
            <table>
                ...
                <tr class="tagheading">
                    ...
                    <td>
                        Vat ({{($saleorder->vat/$saleorder->subtotal)*100}}%)
                    </td>
            ...
            <h3 class="py-5"><input type="submit" value="Create Invoice " class="bg-gray-700 py-1 px-4 rounded-sm text-white text-lg bg-opacity-50 hover:bg-red-800 focus:bg-white"></h3>
</form>
</div>
</body>
